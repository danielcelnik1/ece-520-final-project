...
HD_PWD='c:/users/djdan/onedrive/documents/csun/520a/matrix/ip_repo/edit_matrix_accel_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_accel_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_accel_v1_0.tcl
